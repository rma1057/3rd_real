<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<!-- HOME Logo 시작-->
  <a class="navbar-brand" href="http://localhost:8080/3rd_pprj/view/main/home.jsp" style="margin-left: 30px; font-size: 40px;  font-family:'Yeseva One', cursive ; color: #FFFFFF;" id="nav-link" >[:P]</a>
	<!-- HOME Logo 끝-->
   ...
   <div class="collapse navbar-collapse" id="navbarNavDropdown" style="margin-left: 55%; font-family:'Amaranth','Yeseva One', cursive ; font-size: 22px;">
    <ul class="navbar-nav ">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          <a class="dropdown-item" href="http://localhost:8080/3rd_pprj/view/board/notice_list.jsp" id="sub-menuItem">공지사항</a>
          <a class="dropdown-item" href="http://localhost:8080/3rd_pprj/view/board/qna_list.jsp" id="sub-menuItem">문의게시판</a>
        </div>
      </li>
