...
<div id="container">   
	...
	<img style="width:1100px;height:300px" src="http://211.63.89.150:8080/3rd_prj/common/images/main.PNG"></div><br/>
  ...
  <div class="card">
    ...
    <img src="http://211.63.89.150:8080/3rd_prj/common/images/<c:out value="${list.image}"/>" class="card-img-top">
    <div class="card-body">
