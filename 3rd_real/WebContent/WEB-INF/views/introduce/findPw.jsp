...
<img style="width:80px;height:60px" src="http://localhost:8080/jsp_prj/common/images2/password.png">
비밀번호 찾기
</div>
...
<form>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-4">
      <input type="password" class="form-control" id="inputPassword3" placeholder="number">
    </div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-4">
      <input type="password" class="form-control" id="inputPassword3" placeholder="answer">
    </div>
  </div>
  <div class="form-group row">
    <div class="col-sm-10" style="margin: auto">
      <button type="submit" class="btn btn-primary btn-sm" id="find">찾기</button>
