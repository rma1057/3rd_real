...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner" style="width:1100px; height:700px; ">
    <div class="carousel-item active">
      <img src="http://localhost:8080/3rd_real/common/images/4.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="http://localhost:8080/3rd_real/common/images/4-1.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="http://localhost:8080/3rd_real/common/images/4-2.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="http://localhost:8080/3rd_real/common/images/4-5.jpg" class="d-block w-100" alt="...">
    </div>
  </div>
...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner" style="width:1100px; height:700px;">
    <div class="carousel-item active">
      <img src="http://localhost:8080/3rd_real/common/images/7-5.png" class="d-block w-100" >
    </div>
    <div class="carousel-item">
      <img src="http://localhost:8080/3rd_real/common/images/7.png" class="d-block w-100" >
    </div>
    <div class="carousel-item">
      <img src="http://localhost:8080/3rd_real/common/images/7-1.png" class="d-block w-100" >
    </div>
  </div>
  <a class="carousel-control-prev" href="#carouselExampleIndicators" role="button" data-slide="prev">
    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
