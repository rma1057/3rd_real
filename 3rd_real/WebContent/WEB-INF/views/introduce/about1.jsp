...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner" style="width:1100px; height:700px; ">
    <div class="carousel-item active">
      <img src="http://localhost:8080/3rd_prj/common/images/3-1.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="http://localhost:8080/3rd_prj/common/images/3-2.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="http://localhost:8080/3rd_prj/common/images/3.jpg" class="d-block w-100" alt="...">
    </div>
  </div>
...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner" style="width:1100px; height:700px;">
    <div class="carousel-item active">
      <img src="http://localhost:8080/3rd_prj/common/images/11.PNG" class="d-block w-100" >
    </div>
    <div class="carousel-item">
      <img src="http://localhost:8080/3rd_prj/common/images/10.PNG" class="d-block w-100" >
    </div>
    <div class="carousel-item">
      <img src="http://localhost:8080/3rd_prj/common/images/12.PNG" class="d-block w-100" >
    </div>
  </div>
  <a class="carousel-control-prev" href="#carouselExampleIndicators" role="button" data-slide="prev">
    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
