...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner" style="width:1100px; height:600px; ">
    <div class="carousel-item active">
      <img src="http://localhost:8080/3rd_pprj/common/images/15.png" class="d-block w-100" alt="1">
    </div>
    <div class="carousel-item">
      <img src="http://localhost:8080/3rd_pprj/common/images/2-4.jpg" class="d-block w-100" alt="2">
    </div>
    <div class="carousel-item">
      <img src="http://localhost:8080/3rd_pprj/common/images/4-5.jpg" class="d-block w-100" alt="3">
    </div>
    <div class="carousel-item">
      <img src="http://localhost:8080/3rd_pprj/common/images/7-5.png" class="d-block w-100" alt="4">
    </div>
    <div class="carousel-item">
      <img src="http://localhost:8080/3rd_pprj/common/images/16.png" class="d-block w-100" alt="5">
    </div>
  </div>
...
저희는 완벽한 프로포즈 준비를 위해 한분한분 친절하게 상담을 진행하고 있으며 또 그에 맞는 준비를 도와드립니다.
  ...
  <img src="http://localhost:8080/3rd_pprj/common/images/8-2.jpg" class="ml-3" style="width:450px; height:300px" >
</div>
  <li class="media my-4">
   <img src="http://localhost:8080/3rd_pprj/common/images/4-1.jpg" class="mr-3" style="width:450px; height:300px" >
    <div class="media-body">
...
<div class="media">
  ...
  <img src="http://localhost:8080/3rd_pprj/common/images/2-5.jpg" class="ml-3" style="width:450px; height:300px" >
</div>
</div>
